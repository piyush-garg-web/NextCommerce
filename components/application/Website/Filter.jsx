...
<Button type='button' variant='destructive' className='w-full'asChild>
  ...
  <AccordionItem value="2">
    ...
    <AccordionContent>
     <Slider className='relative top-2' defaultValue={[0,3000]} max={3000} step={1} onValueChange={handlePriceChange} />

     <div className='flex justify-between items-center pt-2 relative top-2.5'>
      <span>
     ...
     <div className='mt-4 relative top-2'>
<CustomButton onClick={handlePriceFilter} type='button' text='Filter Price' className='rounded-full cursor-pointer' />
     </div>
    </AccordionContent>
  </AccordionItem>
