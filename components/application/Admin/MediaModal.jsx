...
const MediaModal = ({ open, setOpen, selectedMedia, setSelectedMedia, isMultiple }) => {
    ...
    return (
        <Dialog
            ...
            <DialogContent className="sm:max-w-[80%] h-screen p-0 py-10 bg-transparent border-0 shadow-none" onInteractOutside={(e) => e.preventDefault()} >
                                ...
                                <>
                                    ...
                                    {hasNextPage ?
                                        <div className='flex justify-center py-5'>
                                            <CustomButton type='button' onClick={() => fetchNextPage()} loading={isFetching} text='Load More' />
                                        </div> :
