                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleOtpVerification)} >
                        <div className="text-center">
                            ...
                            <p className="text-md">We Have Sent An One-Time Password To Your Registered E-Mail Address. OTP Is Valid For 10 Minutes Only.</p>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <CustomButton loading={loading} type="submit" text="Verify" className="w-[300px] mt-7 cursor-pointer" />
                        </div>
                        <div className='text-center mt-5 flex flex-col justify-center items-center'>
                            {!isResendingOtp ? <button onClick={resendOTP} type="button" className="text-blue-500 cursor-pointer hover:underline" >Resend OTP</button> : <span className='text-md'>Resending ...</span>}
                        </div>
