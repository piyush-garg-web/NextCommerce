...
import { DT_COUPON_COLUMNS} from '@/lib/column'
import { columnConfig } from '@/lib/helperfunctions'
import {ADMIN_DASHBOARD, ADMIN_TRASH, ADMIN_COUPON_SHOW, ADMIN_COUPON_EDIT, ADMIN_COUPON_ADD } from '@/Routes/adminpanel'
    ...
    <div>
      ...
      <Card className='py-0 rounded shadow-sm gap-0'>
        <CardHeader className='pt-3 px-3 border-b [.border-b]:pb-2'>
          <div className='flex justify-between items-center '><h4 className='font-semibold text-xl'>Show Coupon</h4>
          <Button className='cursor-pointer'>
            <FaPlus />
            <Link href={ADMIN_COUPON_ADD}>New Coupon
            </Link>
          </Button> </div>
