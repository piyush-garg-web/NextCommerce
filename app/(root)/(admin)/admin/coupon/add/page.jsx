...
import { ADMIN_CATEGORY_SHOW, ADMIN_COUPON_SHOW, ADMIN_DASHBOARD, ADMIN_PRODUCT_SHOW } from '@/Routes/adminpanel'
                ...
                <CardContent className='pb-5'>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} >
                            ...
                            <div className="flex justify-center"> <CustomButton loading={loading} type="submit" text="Add Coupon" className="cursor-pointer mt-4" />
                            </div>
