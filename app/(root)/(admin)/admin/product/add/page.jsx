...
import { ADMIN_CATEGORY_SHOW, ADMIN_DASHBOARD, ADMIN_PRODUCT_SHOW } from '@/routes/adminpanel'
...
const [selectedMedia, setSelectedMedia]=useState([])
 ...
 useEffect(() => {
    ...
    const formSchema = zschema.pick({
        name: true, slug: true, category: true,
...
<div onClick={()=>setOpen(true)} className='bg-gray-50 dark:bg-card border w-[200px] mx-auto p-5 cursor-pointer'>
    <span className='font-semibold'>Select Media</span>
                            ...
                            <div className="flex justify-center"> <CustomButton loading={loading} type="submit" text="Add Product" className="cursor-pointer mt-4" />
                            </div>
