...
import { ADMIN_CATEGORY_SHOW, ADMIN_DASHBOARD, ADMIN_PRODUCT_SHOW, ADMIN_PRODUCT_VARIANT_SHOW } from '@/Routes/adminpanel'
...
const AddProduct = () => {
    ...
    const { data: getProduct } = useFetch('/api/product?deleteType=SD&&size=1000000')
...
const [selectedMedia, setSelectedMedia]=useState([])
 ...
 useEffect(() => {
    ...
    const formSchema = zschema.pick({
        ...
        mrp: true, sellingPrice: true, discountPercentage: true, 
    })
...
<div onClick={()=>setOpen(true)} className='bg-gray-50 dark:bg-card border w-[200px] mx-auto p-5 cursor-pointer'>
    <span className='font-semibold'>Select Media</span>
                            ...
                            <div className="flex justify-center"> <CustomButton loading={loading} type="submit" text="Add Product Variant" className="cursor-pointer mt-4" />
                            </div>
