...
const deleteMutation=useDeleteMutation('media-delete','/api/media/delete')
  ...
  <Label className='text-foreground'>
    ...
    <div className='flex gap-2'>
      ...
      Delete Permanently
            ...
            : 
            <>
            { data.pages.flatMap(page=>page.mediaData.map(media=>media._id)).length===0 && <div className='text-center'>No Data Found</div>}
...
{hasNextPage &&    
<CustomButton className='cursor-pointer' type="button" loading={isFetching} onClick={()=>fetchNextPage()} text="Load More" />
