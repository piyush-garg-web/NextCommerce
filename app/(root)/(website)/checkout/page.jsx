...
try {
  ...
  const razOption = {
    ...
    "image": "https://res.cloudinary.com/dupsqnzdm/image/upload/v1761907414/logo-black_hidfso.webp",
    "order_id": order_id, 
...
<div className='mb-3'>
<CustomButton type='submit' text='Place Order' className='bg-black rounded-full px-5 cursor-pointer' loading={placingOrder} />
</div>
           ...
           <div className='lg:w-[40%] w-full'>
            ...
            <div className='rounded bg-gray-50 p-5 sticky top-5 w-[400px]'>
            ...
            <div className='flex items-center gap-5'>
              ...
              <div>
                <h4 className='font-medium line-clamp-1'>
                  <Link href={WEBSITE_PRODUCT_DETAILS(product.url)}>{product.name}
                  </Link>
                </h4>
...
<p className='text-nowrap text-sm mt-2'>{product.qty} x {product.sellingPrice.toLocaleString('en-IN',{style:'currency',currency:'INR'})}  </p>
          </td>
        </tr>
      )
    )}
...
{taxAmount.toLocaleString('en-IN',{style:'currency',currency:'INR'})}
                    ...
                    <tr>
                      <td className='font-medium py-2 text-xl'>
                        Total
                      </td>
                      <td className='text-end py-2'>
...
<div className='w-[100px]'>
  ...
  className='w-full cursor-pointer' loading={couponLoading} />
</div>
